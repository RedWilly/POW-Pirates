...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
  ...
  return (
    ...
    <StyledWhiteList>
       ...
       <div className='Data'>
            <h1 style={{marginBottom:'30px'}}>POW PIRATES WHITELIST</h1>

            <p
            style={{marginBottom:'15px'}}
            >
            to be whitelisted means your address wallet is allowed for the minting of Pow Pirates  NFTs on Pre-sale and allows the POW Pirates team to reward early supporters with guaranteed slots, Whitelisting also allows supporters to avoid “gas wars”, which is when multiple people try to mint NFTs at the same time, driving up transaction prices.  The pre-approved users on the whitelist are able to spread out their mints in such a way that they are not all transacting at the same time, hence avoiding a sudden spike in transaction prices.
            </p>
        ...
        <div className='Card'>
           ...
           <a href='https://t.me/Pirates3D' target='_blank'><button>Apply For whitelist</button></a>
        </div>
       </div>
    </StyledWhiteList>
    </motion.div>
