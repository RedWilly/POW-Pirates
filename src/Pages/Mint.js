...
function Mint() {
      ...
      const handleClick1 = () => {
      if(counter<15) setCounter(counter + 1); 
      }
      const handleClick2 = () => {
                    ...
                    <p className='Par'>
                      {
                        ...
                        `1 POW Pirate costs ${ethers.utils.formatEther(ContractInfo.cost)} ETHW (Excluding gas fees)`
                        : ContractInfo.SaleStep == 3?
                        'All 2100 NFTs have sold out thank you and congrats to all participants!'
